...
// Live reference: https://ai-orbit.palamrendra-pm.workers.dev/api/v1/leaderboard

export async function GET(req: NextRequest) {
  const demo = {"entries":[],"categories":["Audio & Voice","Chatbot","Code Assistant","Copywriting"]};
